...
<body>
    <h1>Добро пожаловать на сайт предвыборной кампании Первого кандидата!</h1>
    ...
    <button class="button" onclick= "document.location='reg.jsp'">Выбрать кандидата Н1</button> <!-- Кнопка добавлена здесь -->
</body>
</html>
